...
export default function Quote() {
  return <>
    ...
    <section className="section-pad"><div className="section-shell grid gap-12 lg:grid-cols-[.7fr_1.3fr] lg:items-start"><div><p className="eyebrow">What to include</p><h2 className="display mt-3 text-4xl font-semibold leading-tight text-[#073c2d]">A few details help us move faster.</h2><div className="mt-8 space-y-5"><Info Icon={FileText} title="Product & grade" text="Tell us which spice, form, and specification you’re looking for." /><Info Icon={Globe2} title="Destination & volume" text="Share your country, target quantity, and timeline." /><Info Icon={MessageCircle} title="Your application" text="A little context helps us recommend the right pack and route." /></div><div className="mt-8 rounded-2xl bg-[#e8f1ec] p-5 text-sm leading-6 text-[#66716b]">Prefer a quick conversation? <a className="font-bold text-[#0b6e4f]" href="https://wa.me/919871496262" target="_blank" rel="noreferrer">Chat with us on WhatsApp</a>.</div></div><EnquiryForm kind="quote" /></div></section>
  </>;
}
