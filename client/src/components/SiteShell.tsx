      ...
      <header className="sticky top-0 z-30 border-b border-[#dfe8e1]/80 bg-[#f8f5ee]/95 backdrop-blur-md">
        <div className="section-shell flex h-[76px] items-center justify-between">
          ...
          <div className="hidden items-center gap-3 md:flex">
            <a href="https://wa.me/919810610262?text=Hello%20DivineGrow%2C%20I%27d%20like%20to%20discuss%20a%20spice%20requirement." target="_blank" rel="noreferrer" className="text-sm font-bold text-[#0b6e4f] no-underline">WhatsApp</a>
      ...
      <footer className="bg-[#073c2d] text-[#f8f5ee]">
        <div className="section-shell grid gap-12 py-16 md:grid-cols-[1.4fr_1fr_1.2fr]">
          <div>
            ...
            <div className="mt-7 flex gap-3"><a href="https://wa.me/919810610262" target="_blank" rel="noreferrer" className="rounded-full border border-[#547666] px-4 py-2 text-xs font-bold text-[#f4df9d] no-underline hover:bg-[#0b6e4f]">Chat on WhatsApp</a><Link href="/request-quote" className="rounded-full bg-[#d4a017] px-4 py-2 text-xs font-bold text-[#073c2d] no-underline">Request a quote</Link></div>
          </div>
          <div>
